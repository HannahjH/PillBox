...
//    }
//    
//    internal func setNotificationWithDate(_ date: Date, onDaysForNotify weekdays:[Int], snoozeEnabled:Bool,  onSnooze: Bool, soundName: String, index: Int) {
...
//        setNotificationWithDate(snoozeTime, onDaysForNotify: [Int](), snoozeEnabled: true, onSnooze:true, soundName: soundName, index: index)
//    }
//    
//    func reSchedule() {
...
//            if alarm.enabled {
//                setNotificationWithDate(alarm.date as Date, onDaysForNotify: alarm.repeatWeekdays, snoozeEnabled: alarm.snoozeEnabled, onSnooze: false, soundName: alarm.mediaLabel, index: i)
//            }
//        }
//    }
//    
